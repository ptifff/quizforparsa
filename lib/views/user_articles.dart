...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserLecture(),
    );
  }
}

class UserLecture extends StatefulWidget {
  const UserLecture({Key? key}) : super(key: key);

  @override
  _UserLectureState createState() => _UserLectureState();
}

class _UserLectureState extends State<UserLecture> {
